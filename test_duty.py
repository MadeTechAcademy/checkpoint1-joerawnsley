...
def test_duty_class_returns_as_text():
    ...
    assert duty_1.toText() == "Duty 1 Script and code in at least one general purpose language and at least one domain-specific language to orchestrate infrastructure, follow test driven development and ensure appropriate test coverage.\n"
...
def test_duty_class_returns_as_html():
    ...
    assert duty_9.toListElement() == "<li>Duty 9 Apply leading security practices throughout the Software Development Lifecycle (SDLC).</li>\n"